        ...
        <div className="row container">
            <div className="columns" data-aos="fade-right" data-aos-delay="300">
                ...
                <h4>
                    <FormattedMessage
                        id='description'
                        defaultMessage='My name is Rohin Malek and I am a Mern Stack Developer.'
                    />
                </h4>
                <p>
                    <FormattedMessage
                        id='my-description'
                        defaultMessage='Bringing 4 years of experience in web design and development, I focus on continuous growth—enhancing my current expertise while exploring new technologies. I strive to deliver clean, scalable, and innovative solutions aligned with modern development standards."I have been working on web designing and web development for 4 years. Constantly updating the technologies I already master, but also looking to learn new technologies to enrich my skills and improve my good practices as a developer.'
                    />
                </p>
                <ul>
                    <li>
                    ...
                    <li>
                        <p><span>Email:</span> rohinmalek5230@gmail.com</p>
                    </li>
                    <li>
                        <p>
                            <span>
